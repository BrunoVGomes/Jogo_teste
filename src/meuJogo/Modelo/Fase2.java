...
public class Fase2 extends JPanel implements ActionListener {
	...
	public Fase2() {
		...
		ImageIcon referencia = new ImageIcon("res//Cenario2XY.png");
		fundo = referencia.getImage();
		altura = fundo.getHeight(null);
		largura = fundo.getWidth(null);

		int novaLargura = 1014;
		int novaAltura = 631;
	...
	public void paint(Graphics g) {
		...
		if (emJogo == true) {
			...
			for (int i = 0; i < portas.size(); i++) {
				...
				graficos.drawImage(imgPortas.getImagem(null), imgPortas.getX(185), imgPortas.getY(265), null);
				graficos.drawImage(imgPortas.getImagem(null), imgPortas.getX(385), imgPortas.getY(265), null);
				graficos.drawImage(imgPortas.getImagem(null), imgPortas.getX(585), imgPortas.getY(265), null);
			}
